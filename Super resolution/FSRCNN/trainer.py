...
class Trainer:
    ...
    def validate_model(self, loader, model):
        ...
        for images, labels in loader:
            ...
            torchvision.utils.save_image (output[0],'/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/6-FSRCNN/1-50/Test_images/output.png')
            torchvision.utils.save_image (images_batch[0],'/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/6-FSRCNN/1-50/Test_images/Input.png')
            torchvision.utils.save_image (labels_batch[0],'/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/6-FSRCNN/1-50/Test_images/label.png')
