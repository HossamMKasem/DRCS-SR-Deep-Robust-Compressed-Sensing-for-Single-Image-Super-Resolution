...
network = nn.Sequential()
  -- compression part 
   network:add(nn.Reshape(48*48*3))
   network:add(nn.Linear(48*48*3, CR*48*48*3))
   network:add(nn.Reshape(24,24,3))
  local network2=nn.ConcatTable()
	...
	local conv1 = networks.new_conv2(3, 128,
                                           	 false, false, 3)
	local conv2 = networks.new_conv2(128, 128,
                                           	 false, false, 3)										 

	local conv3 = networks.new_conv2(128, 128,
                                           	 false, false, 3)
	local conv4 = networks.new_conv2(128, 128,
                                           	 false, false, 3)										 
	local conv5 = networks.new_conv2(128, 128,
                                           	 false, false, 3)
	local conv6 = networks.new_conv2(128, 64,
                                           	 false, false, 3)
