...
local targets = torch.zeros(trainer.batch_size, 3,
 ...
 -- time taken
  ...
  c=epoch+10
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/5-SRCNN_Torch/1-50/MSE/Time_Train/mean_MSE_error_Train'..c..'.bin',mean_Time)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/5-SRCNN_Torch/1-50/MSE/MSE_Train/mean_MSE_error_Train'..c..'.bin',epoch_error/nbr_samples)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/5-SRCNN_Torch/1-50/MSE/MSE_Train/mean_MSE_error_Train_total_2.bin',mean_MSE_error_Train)
  return epoch_error
end
...
if  epoch==10 then 
  ...
  c=epoch+10
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/5-SRCNN_Torch/1-50/MSE/Time_Test/mean_Time_Test'..c..'.bin',mean_Time_Test)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/5-SRCNN_Torch/1-50/MSE/MSE_Test/mean_MSE_error_Test'..c..'.bin',epoch_error/nbr_samples)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/3-Super_resolution/1-R/5-SRCNN_Torch/1-50/MSE/MSE_Test/mean_MSE_error_Test_total_2.bin',mean_MSE_error_Test)
