...
dataset.train_dataset_bin = "/data/hossamkasem/13-CS/1-Dataset/1-Transformed/1-MNIST/1-R/1-0.5/combined_train_half_initial.bin"
dataset.validation_dataset_bin = "/data/hossamkasem/13-CS/1-Dataset/1-Transformed/1-MNIST/1-R/1-0.5/combined_Validation_half_initial.bin"
dataset.test_dataset_bin = "/data/hossamkasem/13-CS/1-Dataset/1-Transformed/1-MNIST/1-R/1-0.5/combined_test_half_initial.bin"
...
prune_dataset = function(dataset, nbr_examples)
  ...
  local subset_data = torch.Tensor(nbr_examples, 1, 28, 28)
