...
function networks.new(opt)
	 ...
	 -- this part is added for using VGG network										 
	
percep_model = torch.load('VGG_Network.t7')
			--[[
			for _ = 1,27 do
			percep_model:remove()
			end
  ...
  local network2=nn.ConcatTable()
	  ...
	  network:add(networks.new_spatial_tranformer_new(opt.locnet,
                                                  ...
                                                  nil, nil,
                                                  opt.no_cuda))
    local conv1 = networks.new_conv2(512, 100,
                                           	 false, false, 3)
	local conv2 = networks.new_conv2(100, 100,
                                           	 false, false, 3)										 

	local conv3 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv4 = networks.new_conv2(100, 100,
                                           	 false, false, 3)										 
	local conv5 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv6 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv7 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv8 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv9 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv10 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv11 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv12 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv13 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv14 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv15 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv16 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv17 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv18 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv19 = networks.new_conv2(100, 100,
                                           	 false, false, 3)
	local conv20 = networks.new_conv2(100, 512,
                                           	 false, false, 3)		
  ...
  network:add(nn.SpatialConvolution(512, 128, 5, 5, 1, 1, 2, 2))  
  --network:add(nn.SpatialBatchNormalization(64))
  network:add(nn.ReLU(true))

 network:add(nn.SpatialConvolution(128, 64, 5, 5, 1, 1, 2, 2))  
  network:add(nn.ReLU(true))
  network:add(nn.SpatialConvolution(64, 3, 5, 5, 1, 1, 2, 2))
