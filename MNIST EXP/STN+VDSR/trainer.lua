...
function trainer.train(dataset,epoch)
  ...
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/1-Mnist/1-Transformation /1-R/1-50/2-STN/MSE/Time_Train/mean_MSE_error_Train'..epoch..'.bin',mean_Time)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/1-Mnist/1-Transformation /1-R/1-50/2-STN/MSE/MSE_Train/mean_MSE_error_Train'..epoch..'.bin',epoch_error/nbr_samples)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/1-Mnist/1-Transformation /1-R/1-50/2-STN/MSE/MSE_Train/mean_MSE_error_Train_total.bin',mean_MSE_error_Train)
  return epoch_error
end
...
function trainer.test(dataset,epoch)
  ...
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/1-Mnist/1-Transformation /1-R/1-50/2-STN/MSE/Time_Test/mean_Time_Test'..epoch..'.bin',mean_Time_Test)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/1-Mnist/1-Transformation /1-R/1-50/2-STN/MSE/MSE_Test/mean_MSE_error_Test'..epoch..'.bin',epoch_error/nbr_samples)
  torch.save('/data/hossamkasem/13-CS/2-Trained_Network/1-Mnist/1-Transformation /1-R/1-50/2-STN/MSE/MSE_Test/mean_MSE_error_Test_total.bin',mean_MSE_error_Test)
